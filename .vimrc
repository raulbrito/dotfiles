...
augroup vimrcEx
  ...
  autocmd FileType java set sw=4 sts=4 et
...
"map ctrl-arrow keys to change size of window
map <C-Right> <C-W>>
map <C-Left> <C-W><
...
map <leader>x :!xmpfilter -a<cr>
map <leader>X mzggVG!xmpfilter -a<cr>'z
...
map <leader>gs :ClearCtrlPCache<cr>\|:CtrlP public/stylesheets/sass<cr>
map <leader>gf :ClearCtrlPCache<cr>\|:CtrlP features<cr>
map <leader>gg :topleft 100 :split Gemfile<cr>
map <leader>gt :ClearCtrlPCache<cr>\|:CtrlPTag<cr>
